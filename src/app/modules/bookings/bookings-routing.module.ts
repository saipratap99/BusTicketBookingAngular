...
const routes: Routes = [
  ...
  { path: 'search', component: SearchBusesComponent, canActivate: [AuthGuard]},
  { path: 'search/:depLocation/:depId/:arrLocation/:arrId/:date', component: AvailableBusesComponent, canActivate: [AuthGuard]},
